...
public extension XML {
    ...
    final class SAXParser: NSObject, XMLParserDelegate {
...
#if canImport(FoundationXML)
        public typealias FoundationXMLParser = FoundationXML.XMLParser
#else
        public typealias FoundationXMLParser = Foundation.XMLParser
#endif
        ...
        public static func parse(data: Data) throws -> Element {
        ...
        public static func parse(contentsOf url: URL) throws -> Element {
            let data = try Data(contentsOf: url)
            return try parse(data: data)
        }

        public func isValidNamespaceURI(_ uri: String?) -> Bool {
            validNamespaces.contains(uri ?? "")
        }

        public func parser(_ parser: FoundationXMLParser, didStartElement elementName: String, namespaceURI: String?, qualifiedName _: String?, attributes attributeDict: [String: String] = [:]) {
            guard
        ...
        public func parser(_ parser: FoundationXMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName _: String?) {
        ...
        public func parser(_ parser: FoundationXMLParser, foundCharacters string: String) {
