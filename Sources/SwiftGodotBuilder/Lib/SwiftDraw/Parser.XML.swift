...
public typealias DOMXMLParser = XMLParser
...
public struct XMLParser {
    ...
    public struct Options: OptionSet, Sendable {
        ...
        public static let skipInvalidAttributes = Options(rawValue: 1 << 0)
        public static let skipInvalidElements = Options(rawValue: 1 << 1)
    }

    public init(options: Options = [], filename: String? = nil) {
...
public extension AttributeParser {
