...
// MARK: - GNode<ConfirmationDialog> Extension

public extension GNode where T == ConfirmationDialog {
    /// Creates a ConfirmationDialog with declarative buttons.
    ///
    /// ### Example
    /// ```swift
    /// ConfirmationDialog$ {
    ///     DialogButton("Delete Anyway", action: "force_delete")
    /// }
    ...
    func cancelButtonText(_ text: String) -> Self {
        configure { dialog in
