...
struct Chapter5GameUI: GView {
  ...
  var body: some GView {
    CanvasLayer$ {
      ...
      Chapter5MenuOverlay(gameState: gameState)
      Chapter5VictoryOverlay(gameState: gameState, score: score, playTime: playTime)
      Chapter5GameOverOverlay(gameState: gameState, score: score, playTime: playTime)
...
struct Chapter5HUD: GView {
  ...
  var body: some GView {
    ...
    VBoxContainer$ {
      // Title
      Label$()
        .text("CHAPTER 5: PARTICLES & VISUAL POLISH")
...
struct Chapter5MenuOverlay: GView {
  let gameState: State<Chapter5GameState>
...
struct Chapter5VictoryOverlay: GView {
  let gameState: State<Chapter5GameState>
  let score: State<Int>
  let playTime: State<Double>
...
struct Chapter5GameOverOverlay: GView {
  let gameState: State<Chapter5GameState>
  let score: State<Int>
  let playTime: State<Double>
