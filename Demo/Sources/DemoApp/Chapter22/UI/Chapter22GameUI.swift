  ...
  struct GameUI: GView {
    ...
    var body: some GView {
      CanvasLayer$ {
        ...
        WelcomeOverlay(state: state, transitionState: transitionState)
        LevelSelectOverlay(state: state, progress: progress, transitionState: transitionState)
        ...
        LevelCompleteOverlay(state: state, progress: progress, transitionState: transitionState)
        GameOverOverlay(state: state, transitionState: transitionState)
        ...
        TransitionManager(state: transitionState)
      }
      .processMode(.always)
