...
extension Chapter27 {
  ...
  struct NPCDefinition {
    ...
    let makeDialog: (DialogState, ProjectState, PlayerGameState, GameProgress) -> DialogDefinition?
...
// TODO: Make some kind of NPC registry?
extension Chapter27.NPCDefinition {
  ...
  static var oldMan: Chapter27.NPCDefinition { Chapter27.NPCDefinition(
    id: "old_man",
    name: "Old Man",
    color: Color(code: "#44AA44"),
    size: [6, 8],
    animation: "Skull",
    makeDialog: { dialog, _, _, progress in
      Dialog(id: "old_man") {
        Branch("main") {
          // Replaying after beating level
          When({ progress.getProgress(for: "Level_0").completed }) {
  ...
  static var merchant: Chapter27.NPCDefinition { Chapter27.NPCDefinition(
    id: "merchant",
    name: "Merchant",
    color: Color(code: "#4488FF"),
    size: [6, 8],
    animation: "Skull",
    makeDialog: { dialog, _, player, _ in
      Dialog(id: "merchant") {
        Branch("main") {
          When({ dialog.isFirstVisit }) {
  ...
  static var `guard`: Chapter27.NPCDefinition { Chapter27.NPCDefinition(
    id: "guard",
    name: "Guard",
    color: Color(code: "#8844FF"),
    size: [6, 8],
    animation: "Skeleton1Move",
    makeDialog: { dialog, _, _, _ in
      Dialog(id: "guard") {
        Branch("main") {
          When({ dialog.isFirstVisit }) {
  ...
  static var advisors: Chapter27.NPCDefinition { Chapter27.NPCDefinition(
    id: "advisors",
    name: "Sage",
