...
struct Chapter10ParticleSpawner: GView {
  var body: some GView {
    Node2D$()
  ...
  func spawnParticle(type: Chapter10ParticleType, at position: Vector2, parent: Node) {
    let config = getChapter10ParticleConfig(type: type)
  ...
  func getChapter10ParticleConfig(type: Chapter10ParticleType) -> ParticleConfig {
    switch type {
    case .jumpDust:
