...
struct Chapter15ParticleSpawner: GView {
  var body: some GView {
    Node2D$()
  ...
  func spawnParticle(type: Chapter15ParticleType, at position: Vector2, parent: Node) {
    let palette = Chapter15Palette()
    let config = getChapter15ParticleConfig(type: type, palette: palette)
  ...
  func getChapter15ParticleConfig(type: Chapter15ParticleType, palette: Chapter15Palette) -> ParticleConfig {
    switch type {
    case .jumpDust:
