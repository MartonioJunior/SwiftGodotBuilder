...
struct Chapter6GameUI: GView {
  let state: ObservableState<Chapter6GameViewState>

  var body: some GView {
    CanvasLayer$ {
      Chapter6HUD(state: state)
      Chapter6MenuOverlay(state: state)
      Chapter6VictoryOverlay(state: state)
      Chapter6GameOverOverlay(state: state)
...
struct Chapter6HUD: GView {
  ...
  var body: some GView {
    ...
    VBoxContainer$ {
      // Title
      Label$()
        .text("CHAPTER 6: OBSERVABLE STATE PATTERN")
...
struct Chapter6MenuOverlay: GView {
  let state: ObservableState<Chapter6GameViewState>
...
struct Chapter6VictoryOverlay: GView {
  let state: ObservableState<Chapter6GameViewState>
...
struct Chapter6GameOverOverlay: GView {
  let state: ObservableState<Chapter6GameViewState>
