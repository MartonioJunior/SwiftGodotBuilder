...
extension Chapter26.NPCDefinition {
  ...
  static var oldMan: Chapter26.NPCDefinition { Chapter26.NPCDefinition(
    id: "old_man",
    name: "Old Man",
  ...
  static var merchant: Chapter26.NPCDefinition { Chapter26.NPCDefinition(
    id: "merchant",
    name: "Merchant",
    color: Color(code: "#4488FF"),
    size: [6, 8],
    makeDialog: { dialog, _, playerState, _ in
      Dialog(id: "merchant") {
        Branch("main") {
          When({ dialog.isFirstVisit }) {
  ...
  static var `guard`: Chapter26.NPCDefinition { Chapter26.NPCDefinition(
    id: "guard",
    name: "Guard",
  ...
  static var advisors: Chapter26.NPCDefinition { Chapter26.NPCDefinition(
    id: "advisors",
    name: "Sage",
