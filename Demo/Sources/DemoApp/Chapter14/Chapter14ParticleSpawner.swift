...
struct Chapter14ParticleSpawner: GView {
  var body: some GView {
    Node2D$()
  ...
  func spawnParticle(type: Chapter14ParticleType, at position: Vector2, parent: Node) {
    let palette = Chapter14Palette()
    let config = getChapter14ParticleConfig(type: type, palette: palette)
  ...
  func getChapter14ParticleConfig(type: Chapter14ParticleType, palette: Chapter14Palette) -> ParticleConfig {
    switch type {
    case .jumpDust:
