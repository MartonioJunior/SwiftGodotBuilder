...
extension Chapter21.EnemyDefinition {
  static var patrol: Chapter21.EnemyDefinition { Chapter21.EnemyDefinition(
    size: 16,
    speed: 40,
    maxHealth: 2,
    touchDamage: 1,
  ...
  static var flyer: Chapter21.EnemyDefinition { Chapter21.EnemyDefinition(
    size: 16,
    speed: 40,
    maxHealth: 2,
    touchDamage: 1,
