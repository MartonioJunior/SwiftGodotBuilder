...
extension Chapter21.NPCDefinition {
  ...
  static var oldMan: Chapter21.NPCDefinition { Chapter21.NPCDefinition(
    id: "old_man",
    name: "Old Man",
  ...
  static var merchant: Chapter21.NPCDefinition { Chapter21.NPCDefinition(
    id: "merchant",
    name: "Merchant",
  ...
  static var `guard`: Chapter21.NPCDefinition { Chapter21.NPCDefinition(
    id: "guard",
    name: "Guard",
  ...
  static var advisors: Chapter21.NPCDefinition { Chapter21.NPCDefinition(
    id: "advisors",
    name: "Sage",
