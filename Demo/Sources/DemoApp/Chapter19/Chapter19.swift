...
@Godot
final class Chapter19Game: Node2D {
  override func _ready() {
    let rootNode = Chapter19.GameView().toNode()
...
extension Chapter19 {
  struct GameView: GView {
    ...
    var playerSpawnPoint: Vector2 {
      Chapter19.getLevelData(state.currentLevelId)?.playerSpawnPoint ?? [40, 100]
    }
