...
extension Chapter23.CollectibleDefinition {
  static func coin(_ palette: Chapter23.Palette) -> Chapter23.CollectibleDefinition {
    Chapter23.CollectibleDefinition(
      size: 8,
      color: palette.coin,
      shape: palette.octagonShape(radius: 4),
      collectEvent: { Chapter23.Event.coinCollected(position: $0) }
    )
  }

  static func key(_ palette: Chapter23.Palette) -> Chapter23.CollectibleDefinition {
    Chapter23.CollectibleDefinition(
      size: 12,
      color: palette.key,
      shape: palette.keyShape(),
      collectEvent: { Chapter23.Event.keyCollected(position: $0) }
    )
  }

  static func ammo(_ palette: Chapter23.Palette) -> Chapter23.CollectibleDefinition {
    Chapter23.CollectibleDefinition(
      size: 8,
      color: palette.ammo,
      shape: palette.arrowShape(),
      collectEvent: { Chapter23.Event.ammoCollected(position: $0) }
    )
  }

  static func health(_ palette: Chapter23.Palette) -> Chapter23.CollectibleDefinition {
    Chapter23.CollectibleDefinition(
      size: 12,
      color: palette.healthDrop,
      shape: palette.heartShape(size: 12),
      collectEvent: { Chapter23.Event.healthCollected(position: $0) }
    )
  }
}
