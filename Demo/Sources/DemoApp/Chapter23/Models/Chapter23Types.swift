...
extension Chapter23.EnemyDefinition {
  static var patrol: Chapter23.EnemyDefinition { Chapter23.EnemyDefinition(
    size: 16,
    speed: 40,
    maxHealth: 2,
    touchDamage: 1,
  ...
  static var flyer: Chapter23.EnemyDefinition { Chapter23.EnemyDefinition(
    size: 16,
    speed: 40,
    maxHealth: 2,
    touchDamage: 1,
