  ...
  struct SplashOverlay: GView {
          ...
          VBoxContainer$ {
            ...
            Control$ {
              Label$()
                ...
                .theme(["fontSize": 48, "fontColor": palette.cyan])
                .anchorsAndOffsets(.fullRect)
              ...
              Label$()
                .text("CHAPTER 23")
                .horizontalAlignment(.center)
                .theme(["fontSize": 48, "fontColor": palette.cyan.withAlpha(0.3)])
                .anchorsAndOffsets(.fullRect)
    ...
    func startIntroAnimation() {
      Engine.onNextFrame {
        ...
        subtitleNode?.tween { seq in
          seq.delay(0.4).to(.alpha(1.0), duration: 0.5).ease(.out)
        }
