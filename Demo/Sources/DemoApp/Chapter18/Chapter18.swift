...
@Godot
final class Chapter18Game: Node2D {
  override func _ready() {
    let rootNode = Chapter18.GameView().toNode()
...
extension Chapter18 {
  struct GameView: GView {
    ...
    var playerSpawnPoint: Vector2 {
      Chapter18.getLevelData(state.currentLevelId)?.playerSpawnPoint ?? [40, 100]
    }
