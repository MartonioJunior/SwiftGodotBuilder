...
struct Chapter12ParticleSpawner: GView {
  var body: some GView {
    Node2D$()
  ...
  func spawnParticle(type: Chapter12ParticleType, at position: Vector2, parent: Node) {
    let config = getChapter12ParticleConfig(type: type)
  ...
  func getChapter12ParticleConfig(type: Chapter12ParticleType) -> ParticleConfig {
    switch type {
    case .jumpDust:
