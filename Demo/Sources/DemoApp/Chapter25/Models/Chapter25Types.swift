...
extension Chapter25 {
  ...
  enum ParticleType: CaseIterable {
    ...
    var config: ParticleConfig {
      ...
      case .meleeSwoosh:
        return ParticleConfig(
          amount: 12, lifetime: 0.15, explosiveness: 1.0,
          direction: [1, 0], spread: 30,
          initialVelocityMin: 60, initialVelocityMax: 100,
          gravity: [0, 0], color: Self.white
        )
      case .meleeImpact:
        return ParticleConfig(
...
extension Chapter25.EnemyDefinition {
  static var patrol: Chapter25.EnemyDefinition { Chapter25.EnemyDefinition(
    size: 8,
    speed: 40,
    maxHealth: 2,
    touchDamage: 1,
  ...
  static var flyer: Chapter25.EnemyDefinition { Chapter25.EnemyDefinition(
    size: 8,
    speed: 40,
    maxHealth: 2,
    touchDamage: 1,
