...
extension Chapter25.NPCDefinition {
  ...
  static var oldMan: Chapter25.NPCDefinition { Chapter25.NPCDefinition(
    id: "old_man",
    name: "Old Man",
  ...
  static var merchant: Chapter25.NPCDefinition { Chapter25.NPCDefinition(
    id: "merchant",
    name: "Merchant",
  ...
  static var `guard`: Chapter25.NPCDefinition { Chapter25.NPCDefinition(
    id: "guard",
    name: "Guard",
  ...
  static var advisors: Chapter25.NPCDefinition { Chapter25.NPCDefinition(
    id: "advisors",
    name: "Sage",
