...
enum Chapter11Event: EmittableEvent {
  // Game state events
  case goalReached
  case gameReset
  ...
  case weaponSwitched(weaponType: Chapter11WeaponType)
}

enum Chapter11ParticleType {
  case jumpDust
  case landingImpact
  case movementTrail
  case deathExplosion
...
@Observable
class Chapter11GameViewState {
  var gameState: Chapter11GameState = .menu
  ...
  var maxAmmo: Int = 20
  var currentWeapon: Chapter11WeaponType = .melee
